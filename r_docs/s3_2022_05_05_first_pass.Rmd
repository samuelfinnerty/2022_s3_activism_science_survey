...
First let's dop the forward scored variables
```{r}
...
We will not subset this selection to get a spread of relative levels of activism (with a focus on those who do more high risk behaviours as a criteria for differentiation) and identification with scientists and with activists. 
...
I am aiming for 30 people. 

11 people. Let's sample 10 of them and we'll split them into there categories. Those . What is interesting when eyeballying the data is that there doesn't seem to be clean 

Within that 3 p
hmj.forrester@bristol.ac.uk identifies more as an activist but does not actually take much action. interesting. 
 
meredithlairward@gmail.com, big difference between identities. 
